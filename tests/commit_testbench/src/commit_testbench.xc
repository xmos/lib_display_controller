...
/***********************************************************************
 * This test program tests the commit of a new frame for display on LCD.
************************************************************************/
...
#define DISPLAY_CONTROLLER_IMAGE_COUNT (3)
...
void app(client interface app_to_cmd_buffer_i to_dc, client interface res_buf_to_app_i from_dc,
    ...
    /* Commit frame 2 and check the correctness of addresses of lines of the frame in the dummy SDRAM server */
    display_controller_frame_buffer_commit(to_dc,2);
